...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=1.2\textwidth]{imagens/diagramas/classes.png}
    \end{center}
...
\begin{figure}[H]
	\begin{center}
	    \includegraphics[scale=0.3]{imagens/prototipo/login.png}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
	    \includegraphics[scale=0.5]{imagens/prototipo/tela-inicial.png}
	\end{center}
