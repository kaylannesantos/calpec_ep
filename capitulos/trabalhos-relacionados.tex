...
\hline
\textbf{\href{url}{CalPEC}} & Execução penal completa & Inclui progressão, remição, detração, unificação; interface intuitiva & (Qual o ponto fraco do meu trabalho?) \\
\hline
\end{tabular}
\end{table}