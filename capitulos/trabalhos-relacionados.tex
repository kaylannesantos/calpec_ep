...
\hline
\textbf{CalPEC} & Execução penal completa & Inclui progressão, remição, detração; interface intuitiva; armazena dados & Não possui integração com sistemas oficiais; unificação de penas pendente \\
\hline
\end{tabular}
\end{table}