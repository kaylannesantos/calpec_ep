...
%\usepackage[brazilian,hyperpageref]{backref}	 % Inclui nas Referências as páginas onde há as citações COMENTADO-CORRECAO
...
%% Pacotes usados para a formatação de tabelas
\usepackage{booktabs}					% Comandos para tabelas
\usepackage{multirow, array}			% Múltiplas linhas e colunas em tabelas
\usepackage{pifont}                     % Símbolos especiais (✓ e ✗ na tabela)
\usepackage{titlesec}                   % Permite criar múltiplas sub seções
